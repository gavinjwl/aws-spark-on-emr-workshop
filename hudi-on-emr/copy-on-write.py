...
if __name__ == "__main__":
    ...
    if (len(sys.argv) != 2):
        print("Usage: copy-on-write [bucket_name]")
        sys.exit(0)

    spark = SparkSession\
        .builder\
        .appName("copy-on-write")\
        .getOrCreate()
    ...
    hudi_options = {
        ...
        'hoodie.cleaner.delete.bootstrap.base.file': 'false',  # Default Value: false
        'hoodie.cleaner.commits.retained': 3,                # Default Value: 10
        'hoodie.commits.archival.batch': 3,                  # Default Value: 10
